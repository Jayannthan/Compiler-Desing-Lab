...
while_block: WHILE ROUND_LEFT TERM REL_OP TERM ROUND_RIGHT '{' { printf("LABEL_%d:\n if not %s %s %s then goto FALSE_%d\n\nTRUE_%c:\n ", controlCount, $3, $4, $5, controlCount, controlCount); } line '}' { printf("FALSE_%d: ", controlCount); controlCount++; } line
	...
	| WHILE ROUND_LEFT TERM ROUND_RIGHT DO '{' { printf("LABEL_%d:\n if not %s then goto FALSE_%d\n\nTRUE_%c: \n", controlCount, $3, controlCount, controlCount); } line '}' { printf("FALSE_%d: ", controlCount); cc++; } line
