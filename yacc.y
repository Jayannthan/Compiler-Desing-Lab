%{
#include <stdlib.h> #include <stdio.h> int yylex(void); extern FILE* yyin; #include "y.tab.h" int error = 0;
/*extern int debug;*/
%}
...
declaration : DTYPE ID ASSIGN_OP INT { printf("Declaration with assignmentfound!\n");}
